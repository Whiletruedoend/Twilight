 ...
 * Четвёртая - нужно самому сидеть в других платформах;
 ...
 Схема и таблица моделей находится под заголовком [Схемы и скриншоты](#Схемы-и-скриншоты);
...
* [TG] Если у поста в telegram был текст и аттачменты, и при редактировании убрать все аттачменты, то пост полностью удалится. Это особенность телеги, я не могу превратить подпись в текст, нужно создавать новый ност;
