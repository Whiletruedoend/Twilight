...
## Известные баги
Блок = сообщение длиной максимум 4096 символов;
* При редактировании существующей новости если блоков новостей два и больше, то в сообщении не указывается название поста;
* Если каналов для поста в тг 2 и больше то:
